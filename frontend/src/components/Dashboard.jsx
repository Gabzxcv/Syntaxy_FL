            ...
            <div className="account-section">
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px', marginBottom: '20px' }}>
                <div style={{ background: 'var(--bg-card)', borderRadius: '12px', padding: '16px', border: '1px solid var(--border-color)', textAlign: 'center' }}>
                  ...
                  <div style={{ fontSize: '1.8rem', fontWeight: 700, color: analysisStats.avgClonePercentage > 50 ? '#ef4444' : analysisStats.avgClonePercentage > 25 ? '#f59e0b' : '#22c55e', fontFamily: "'Outfit', sans-serif" }}>{analysisStats.avgClonePercentage}%</div>
                </div>
                <div style={{ background: 'var(--bg-card)', borderRadius: '12px', padding: '16px', border: '1px solid var(--border-color)', textAlign: 'center' }}>
                  ...
                  <div style={{ fontSize: '1.8rem', fontWeight: 700, color: analysisStats.avgComplexity > 10 ? '#ef4444' : analysisStats.avgComplexity > 5 ? '#f59e0b' : '#22c55e', fontFamily: "'Outfit', sans-serif" }}>{analysisStats.avgComplexity}</div>
                </div>
                <div style={{ background: 'var(--bg-card)', borderRadius: '12px', padding: '16px', border: '1px solid var(--border-color)', textAlign: 'center' }}>
                  ...
                  <div style={{ fontSize: '1.8rem', fontWeight: 700, color: analysisStats.avgMaintainability >= 65 ? '#22c55e' : analysisStats.avgMaintainability >= 35 ? '#f59e0b' : '#ef4444', fontFamily: "'Outfit', sans-serif" }}>{analysisStats.avgMaintainability}</div>
                </div>
                <div style={{ background: 'var(--bg-card)', borderRadius: '12px', padding: '16px', border: '1px solid var(--border-color)', textAlign: 'center' }}>
                  ...
                  <div style={{ fontSize: '1.8rem', fontWeight: 700, color: analysisStats.totalClones > 0 ? '#ef4444' : '#22c55e', fontFamily: "'Outfit', sans-serif" }}>{analysisStats.totalClones}</div>
                </div>
              </div>
